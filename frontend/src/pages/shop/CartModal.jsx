...
const CartModal = ({ products, isOpen, onClose }) => {
  ...
  const handleQuantity = (type, id) => {
    dispatch(updateQuantity({ type, id })); // Fixed payload structure
  };
      ...
      >
        <div className="p-4 mt-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={onClose} // Corrected `onClose` function reference
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                      ...
                      <div className="ml-5">
                        <button onClick= {(e) =>handleRemove (e, item.id)} className="text-red-500 hover:text-red-800">Remove</button>
                      </div>
                    </div>
                  </div>
                </div>
